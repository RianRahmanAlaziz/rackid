            ...
            <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
                ...
                <div class="w-full sm:w-auto flex">
                    <button class="btn btn-primary shadow-md mr-2" data-tw-toggle="modal"
                        data-tw-target="#header-footer-modal-preview">Upload New Gambar</button>
                </div>
            </div>
                        ...
                        <div class="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in">
                            <a class="w-3/5 file__icon file__icon--image mx-auto">
                                <div class="file__icon--image__preview image-fit">
                                    <img alt="{{ $file->nfile }}" src="/assets/images/gallery/{{ $file->gambar }}">
                                </div>
                            </a>
                ...
                <div class="modal-content">
                    <div class="modal-body p-0">
                        ...
                        <div class="px-5 pb-8 text-center">
                            ...
                            <form action="/dashboard/gallery/{{ $file->id }}" method="post">
                                @method('DELETE')
                                @csrf
