                                ...
                                <div class="form-label xl:w-64 xl:!mr-10">
                                    <div class="text-left">
                                        ...
                                        <div class="leading-relaxed text-slate-500 text-xs mt-3"> Slug adalah bagian dari
                                            URL yang menunjukkan halaman atau konten tertentu di sebuah website </div>
                                    </div>
                                </div>
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                <div class="form-label xl:w-64 xl:!mr-10">
                                    <div class="text-left">
                                        ...
                                        <div class="leading-relaxed text-slate-500 text-xs mt-3"> Pilih Category yang sesuai
                                            untuk produk, untuk memudahkan user
                                            dalam menemukan produk di website.</div>
                                    </div>
                                </div>
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                        ...
                        <div class="mt-5">
                                ...
                                <div class="form-label xl:w-64 xl:!mr-10">
                                    <div class="text-left">
                                        ...
                                        <div class="leading-relaxed text-slate-500 text-xs mt-3"> Masukkan kode Unique yang
                                            digunakan untuk mengidentifikasi produk secara spesifik.
                                        </div>
                                    </div>
                                </div>
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="productid" name="productid" type="text" class="form-control"
                                        placeholder="Product ID" value="{{ old('productid') }}">
                                    @error('productid')
                                        <div class="text-danger form-help text-left">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-32 mt-3 xl:mt-0 flex-1">
                                    {{-- ✅ Saat edit, ambil dari $product->description, kalau create pakai old() --}}
                ...
                <div class="intro-y box p-5 mt-5">
                    <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                        ...
                        <div id="formContainer" class="mt-5">
                            <!-- Thumbnail Section -->
                            <div class="form-inline items-start flex-col xl:flex-row mt-10">
                                <label for="thumbnail" class="form-label w-full xl:w-64 xl:!mr-10">
                                    <div class="text-left">
                                        <div class="flex items-center">
                            ...
                            <div
                                class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0 group-url">
                                <label class="form-label xl:w-64 xl:!mr-10">
                                    <div class="text-left">
                                        <div class="flex items-center">
                    ...
                    <!-- Add More Button -->
                    <button type="button" class="btn py-2 px-4 btn-outline-secondary w-full md:w-24 text-xs mt-3"
                        id="tambahBtn">
                        <i data-lucide="plus"></i> Add Video Link
                    </button>
                </div>
                <!-- END: Uplaod Product -->
...
@push('script')
    ...
    {{-- <script>
        document.getElementById('addURLBtn').addEventListener('click', function() {
            const container = document.getElementById('dynamicURLContainer');
            const group = document.createElement('div');
            group.classList.add('form-inline', 'items-start', 'flex-col', 'xl:flex-row', 'mt-5', 'pt-5',
                'group-url');

            group.innerHTML = `
            <label class="form-label xl:w-64 xl:!mr-10"></label>
            <div class="w-full mt-3 xl:mt-0 flex-1 flex gap-2">
                <input name="thumbnail_links[]" type="url" class="form-control"
                    placeholder="https://youtube.com/embed/...">
                <button type="button" class="btn btn-danger removeURLBtn">Hapus</button>
            </div>
        `;
            container.appendChild(group);

            group.querySelector('.removeURLBtn').addEventListener('click', function() {
                group.remove();
            });
        });
    </script> --}}
